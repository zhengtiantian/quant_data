...
# Ensure this file's own directory is importable regardless of how this
# module is invoked (direct script run already gets this from Python
# automatically; being imported via its full package path, e.g.
# `from collectors.news.gdelt.historical_collector import ...`, does not).
_GDELT_DIR = os.path.dirname(os.path.abspath(__file__))
