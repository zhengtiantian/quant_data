...
Usage:
  python research/backtest/backtest_event_driven.py --collection daily_symbol_features_company_matched_v2
  python research/backtest/backtest_event_driven.py --max-hold 30 --min-hold 5 --top-n 5
"""
