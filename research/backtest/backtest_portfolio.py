...
Run:
  ...
  .venv311/bin/python research/backtest/backtest_portfolio.py
"""
...
from research.signals.score_daily_signals import compute_score, _WEIGHTS_BY_REGIME  # reuse live scoring
